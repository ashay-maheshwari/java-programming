 ...
 * ShopKeepers.java
 *
 * Created on September 27, 2013, 9:28 PM
 */
...
public class ShopKeepers extends javax.swing.JFrame {
    
    /** Creates new form ShopKeepers */
    Connection con=null;
    Statement st=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DETAILS OF SHOP OWNERS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(evt.getSource()==jButton1)
        {
            ...
            String shop_id=jTextField6.getText();
            try{
                System.out.println("INSIDE TRY");
                Class.forName("com.mysql.jdbc.Driver");
                con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ashay","root","");
                st=con.createStatement();
                st.executeUpdate("insert into ShopOwners values('"+name+"','"+contact+"','"+brand+"','"+category+"','"+email+"','"+shop_id+"')");
